...
async function main() {
  ...
  await Promise.all([
    createQuote({
      ...
      lines: [
        {
          catalogItemId: website.id,
          name: website.name,
          description: 'Web corporativa con páginas principales y responsive.',
          quantity: 1,
          unitPrice: 2800,
        },
        {
          catalogItemId: consulting.id,
          name: consulting.name,
          description: 'Sesión inicial de estrategia y alcance.',
          quantity: 1,
          unitPrice: 450,
        },
      ],
    ...
    createQuote({
      ...
      lines: [
        {
          catalogItemId: maintenance.id,
          name: maintenance.name,
          description: 'Tres meses de mantenimiento y mejoras menores.',
          quantity: 3,
          unitPrice: 390,
        },
      ],
      ...
      lines: [
        {
          catalogItemId: website.id,
          name: website.name,
          description: 'Web corporativa para nueva línea de negocio.',
          quantity: 1,
          unitPrice: 2800,
        },
        {
          catalogItemId: seo.id,
          name: seo.name,
          description: 'Auditoría técnica inicial.',
          quantity: 1,
          unitPrice: 690,
        },
      ],
      ...
      lines: [
        {
          catalogItemId: consulting.id,
          name: consulting.name,
          description: 'Consultoría inicial para definir prioridades.',
          quantity: 1,
          unitPrice: 450,
        },
      ],
